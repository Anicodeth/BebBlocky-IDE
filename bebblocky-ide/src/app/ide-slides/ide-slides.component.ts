...
export class IdeSlidesComponent {
  ...
  public slides: SlideInterface[] = [
    { backgroundUrl: 'https://wallpaper-mania.com/wp-content/uploads/2018/09/High_resolution_wallpaper_background_ID_77700366562.jpg', title: 'Page 1', content: 'These are the contents of page 1.' },
